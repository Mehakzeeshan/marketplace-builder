...
export default async function ShopPage2 () {
      ...
      <div className="flex justify-between bg-[#f9f1e7] py-6 flex-wrap">
        <div className="flex md:pl-16 gap-6 mt-1 flex-wrap items-center">
          ...
          <h3 className="font-semibold flex gap-8">
            <p>|</p>Showing 9-16 of 24 results
          </h3>
        </div>
  ...
  <PaginationContent>
    <PaginationItem>
      <PaginationPrevious href="/shop" />
    </PaginationItem>
    <PaginationItem>
      <PaginationLink href="/shop" className="px-5 py-4 rounded-xl bg-[#f9f1e7]">1</PaginationLink>
      <PaginationLink href="/shop2" className="px-5 py-4 rounded-xl bg-[#b88e2f] ml-4">2</PaginationLink>
